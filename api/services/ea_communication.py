...
class EAServer:
    ...
    async def send_signal_to_ea(
        self, signal: TradingSignal, ea_address: tuple = None
    ) -> bool:
...
class EAClient:
    ...
    async def send_trade_result(
        self, signal_id: str, success: bool, ticket: int = None, error: str = ""
    ):
