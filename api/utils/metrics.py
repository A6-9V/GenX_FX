...
class MetricsCollector:
    ...
    def record_auth_event(self, auth_type: str, success: bool, token_type: Optional[str] = None):
    ...
    def record_rate_limit_hit(self, endpoint: str, client_ip: str, blocked: bool = False):
