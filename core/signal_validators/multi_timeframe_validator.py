    ...
    def _generate_validation_notes(
        ...
        try:
            ...
            if abs(consensus_score) > 0.7:
                ...
                notes.append(
                    f"Weak consensus - mixed signals across timeframes (score: {consensus_score:.2f})"
                )
            ...
            notes.append(
                f"Signal distribution: {signal_counts['buy']} BUY, {signal_counts['sell']} SELL, {signal_counts['neutral']} NEUTRAL"
            )
